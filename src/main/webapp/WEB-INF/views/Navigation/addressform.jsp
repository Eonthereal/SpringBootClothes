    ...
    <body>
        ...
        <div class="container" id="addressform">
            <form:form action="${pageContext.request.contextPath}/user/cart/address/updateaddress" method="POST" modelAttribute="order">
                ...
                <form:input id="city" path="city" name="city" required="true"/>
                <br>

                <label for="address">Address:</label>
                <form:input id="address" path="address" name="address" required="true"/>
                <br>

                <label for="zipcode">Zipcode:</label>
                <form:input id="zipcode" path="zipcode" name="zipcode" required="true"/>
                ...
                <input class="submitbutton" type="submit" value="Order Review"/>
