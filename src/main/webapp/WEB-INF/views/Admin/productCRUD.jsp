            ...
            <div class="row--">
                ...
                <div class="col-md-9">
                    ...
                    <sec:authorize access ="hasRole('ADMIN')">
                        <a href="${pageContext.request.contextPath}/admin"><strong><i class="glyphicon glyphicon-dashboard"></i> Admin Home</strong></a><a class="dashboard" style="text-decoration:none;" onmouseover="this.style.color = '#478BCA';" onmouseout="this.style.color = '';"> / List of Products</a>
                                </sec:authorize> 
                    <!--</div>-->   
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row--">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/product/create" class="btn btn-info col-sm-2" style="margin-bottom: 10px; margin-top: 0; background-color:#6BCE1B; border-color:#6BCE1B"><i class="glyphicon glyphicon-plus"></i>Add product</a>
                                <p></p>
                                <table border="1">
                                    <thead>
                                        <tr>
