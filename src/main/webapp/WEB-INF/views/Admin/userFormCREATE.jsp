                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row-2">
                                <div class="panel">    
                                    <form:form action="${pageContext.request.contextPath}/admin/user/create" method="POST" modelAttribute="user" class="form-horizontal">          
                                        <%--<form:hidden id="userid" path="userid"/>--%>
                                        <fieldset class="fieldset">
                                            <h3 class="fieldset-title">Add User</h3>
                                            ...
                                            <!--Password-->
                                            <div class="form-group">
                                                <label for="password" class="col-md-2 col-sm-3 col-xs-12 control-label">Password</label>
                                                <div class="col-md-10 col-sm-9 col-xs-12">
