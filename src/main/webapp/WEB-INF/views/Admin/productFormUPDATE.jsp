                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row-2">
                                <div class="panel">
                                    <form:form action="${pageContext.request.contextPath}/admin/product/update" method="POST" modelAttribute="product" class="form-horizontal">          

                                        <fieldset class="fieldset">
                                            <h3 class="fieldset-title">Update Product</h3>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10 col-sm-9 col-xs-12">
                                                    <form:input id="price" path="price" step="0.01" />
                                            ...
                                            <!--Offer-->
                                            <div class="form-group">
                                                <label for="offer" class="col-md-2 col-sm-3 col-xs-12 control-label">Stock</label>
                                                <div class="col-md-10 col-sm-9 col-xs-12">
                                            ...
                                            <%--path = ?? ????? ?? ??? "???????????" ?? ????????. ??? ????? to userList ??? User --%>
                                            <%--items = ?? ????? ??? ?????? ????? ??? ????? ??? ModelAttributes(??. UserControllerAdmin class) --%>
                                            <%--itemLabel = ??? ??? ????? ?? ??????? ?? ??????? ???? ?? Labels ???? HTML --%>
                                            <%--itemValue = ??? ??? ????? ?? ?????? ???? --%>
                                            <%--itemLabel =  ?? tag ?? ???? ???? HTML--%>
